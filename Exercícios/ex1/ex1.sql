...
CREATE TABLE tb_localizacao(
    ...
    cep VARCHAR(12),
    cidade VARCHAR(30) CONSTRAINT nn_loc_cidade NOT NULL,
    estado VARCHAR(25));
...
CREATE TABLE tb_departamento(
    ...
    nm_departamento VARCHAR(30) CONSTRAINT nn_nm_departamento NOT NULL,
    id_gerente NUMBER(6),
    id_localizacao NUMBER(4));
...
ADD (
    CONSTRAINT pk_tb_funcao PRIMARY KEY(id_funcao));
